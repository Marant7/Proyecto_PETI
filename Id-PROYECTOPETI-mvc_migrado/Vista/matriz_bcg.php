...
<head>
    ...
    <link rel="stylesheet" href="../public/css/bcg.css">    
...
<body>
    <div style="display:flex; min-height:100vh;">
        ...
        <div class="content">
            <div class="header" style="text-align: center; padding: 20px; background:rgb(255, 255, 255); color: white; border-radius: 12px; margin-bottom: 30px;">
